    ...
    <AppBar position="fixed" style={{background: "linear-gradient(45deg, #530f79,#14134b)",boxShadow:"none",paddingTop:"10px",paddingRight:"50px",paddingLeft:"30px"}}>
      <Toolbar>
        <div style={{ display: 'flex', alignItems: 'center', flexGrow: 1 }}>
          {
            isMobile?(
              <Link to="/" style={{ textDecoration: 'none', color: '#fff',display:"none" }}>
          ...
          <>
            ...
            >
              <MenuIconWrapper open={drawerOpen} style={{marginLeft:"-25px"}}/>
            </IconButton>
            <Link to="/" style={{ textDecoration: 'none', color: '#fff' }}>
            <LogoImage src={Logo} alt="Regen Global Logo" style={{marginRight:"0",marginLeft:"2rem"}} />
