...
import { Autocomplete, Divider, TextField, Typography, useMediaQuery } from "@mui/material";
        ...
        <StyledMainContainer style={{marginTop:"50px"}}>
          {
            ...
            <StyledMainText style={{
                width:"400px"
            }}>
              Find a Regenerative<br/> Medicine Doctor based on your condition
            </StyledMainText>
            <p style={{ color: 'white',
            paddingLeft: "60px",
            width:"400px"
          ...
          <StyledImageContainer style={{
            ...
            {isMobile?(
                <Styleimagecontainer style={{marginRight:"20px"}}>
